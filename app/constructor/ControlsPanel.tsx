  ...
  useControls(
    {
      ...
      Material: folder({
        transmission: { value: config.transmission, min: 0, max: 1, step: 0.01, onChange: (v: number) => setNested('transmission', v) },
        ior: { value: config.ior, min: 1, max: 2.5, step: 0.01, onChange: (v: number) => setNested('ior', v) },
        thickness: { value: config.thickness, min: 0, max: 2, step: 0.01, onChange: (v: number) => setNested('thickness', v) },
        roughness: { value: config.roughness, min: 0, max: 1, step: 0.01, onChange: (v: number) => setNested('roughness', v) },
        chromaticAberration: { value: config.chromaticAberration, min: 0, max: 1, step: 0.01, onChange: (v: number) => setNested('chromaticAberration', v) },
        distortion: { value: config.distortion, min: 0, max: 1, step: 0.01, onChange: (v: number) => setNested('distortion', v) },
        temporalDistortion: { value: config.temporalDistortion, min: 0, max: 0.5, step: 0.01, onChange: (v: number) => setNested('temporalDistortion', v) },
        attenuationColor: { value: config.attenuationColor, onChange: (v: string) => setNested('attenuationColor', v) },
      }),
      Background: folder({
        bgMode: {
      ...
      Cursor: folder({
        ...
        targetLerp: { value: config.targetLerp, min: 0.001, max: 0.2, step: 0.001, onChange: (v: number) => setNested('targetLerp', v) },
        currentLerp: { value: config.currentLerp, min: 0.001, max: 0.2, step: 0.001, onChange: (v: number) => setNested('currentLerp', v) },
        stretchK: { value: config.stretchK, min: 0, max: 5, step: 0.1, onChange: (v: number) => setNested('stretchK', v) },
        maxStretch: { value: config.maxStretch, min: 0, max: 3, step: 0.05, onChange: (v: number) => setNested('maxStretch', v) },
        deadZone: { value: config.deadZone, min: 0, max: 0.5, step: 0.01, onChange: (v: number) => setNested('deadZone', v) },
      }),
      Click: folder({
        ...
        ripplePropagationSpeed: { value: config.ripplePropagationSpeed, min: 0.05, max: 1, step: 0.01, onChange: (v: number) => setNested('ripplePropagationSpeed', v) },
        rippleAmplitude: { value: config.rippleAmplitude, min: 0, max: 2, step: 0.05, onChange: (v: number) => setNested('rippleAmplitude', v) },
        rippleDecay: { value: config.rippleDecay, min: 0.1, max: 5, step: 0.05, onChange: (v: number) => setNested('rippleDecay', v) },
        burstScale: { value: config.burstScale, min: 0, max: 1, step: 0.01, onChange: (v: number) => setNested('burstScale', v) },
        flashColor: { value: config.flashColor, onChange: (v: string) => setNested('flashColor', v) },
      }),
      Lighting: folder({
